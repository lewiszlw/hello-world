...
①HashMap + 单链表实现[LRUCache](https://github.com/lewiszlw/hello-world/blob/master/hello-world-algorithms-java/src/main/java/lewiszlw/datastructure/LRUCache1.java)

②HashMap + 双向链表实现[LRUCache](https://github.com/lewiszlw/hello-world/blob/master/hello-world-algorithms-java/src/main/java/lewiszlw/datastructure/LRUCache2.java)
